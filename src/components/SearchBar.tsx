    ...
    <div className='flex w-full items-center justify-between space-x-2'>
      ...
      <div className='relative mr-1 w-full flex-1'>
        <input
          ...
          onKeyDown={(e) => e.key === 'Enter' && handleSearchSubmit(city)}
          placeholder=' '
      ...
      <button
        className='flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-600 transition duration-300 hover:border-purple-500 hover:bg-purple-700 focus:outline-none active:scale-75 dark:bg-violet-700 dark:hover:border-violet-600 dark:hover:bg-violet-800'
